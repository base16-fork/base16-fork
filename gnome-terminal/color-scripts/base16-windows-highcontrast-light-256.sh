...
# Base16 Windows High Contrast Light - Gnome Terminal color scheme install script
# Fergus Collins (https://github.com/C-Fergus)

[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Windows High Contrast Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-windows-highcontrast-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#fcfcfc', '#800000', '#008000', '#808000', '#000080', '#800080', '#008080', '#545454', '#c0c0c0', '#800000', '#008000', '#808000', '#000080', '#800080', '#008080', '#000000']"
...
gset string palette "#fcfcfc:#800000:#008000:#808000:#000080:#800080:#008080:#545454:#c0c0c0:#800000:#008000:#808000:#000080:#800080:#008080:#000000"
