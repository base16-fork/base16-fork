...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Qualia 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-qualia-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#101010', '#EFA6A2', '#80C990', '#E6A3DC', '#50CACD', '#E0AF85', '#C8C874', '#C0C0C0', '#454545', '#EFA6A2', '#80C990', '#E6A3DC', '#50CACD', '#E0AF85', '#C8C874', '#454545']"
