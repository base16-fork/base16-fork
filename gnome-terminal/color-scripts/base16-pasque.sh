...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Pasque"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-pasque"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#271C3A', '#A92258', '#C6914B', '#804ead', '#8E7DC6', '#953B9D', '#7263AA', '#DEDCDF', '#5D5766', '#918889', '#100323', '#3E2D5C', '#BEBCBF', '#EDEAEF', '#59325C', '#BBAADD']"
...
gset string palette "['#271C3A', '#A92258', '#C6914B', '#804ead', '#8E7DC6', '#953B9D', '#7263AA', '#DEDCDF', '#5D5766', '#918889', '#100323', '#3E2D5C', '#BEBCBF', '#EDEAEF', '#59325C', '#BBAADD']"
