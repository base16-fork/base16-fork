...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Equilibrium Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-equilibrium-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f5f0e7', '#d02023', '#637200', '#9d6f00', '#0073b5', '#4e66b6', '#007a72', '#43474e', '#73777f', '#d02023', '#637200', '#9d6f00', '#0073b5', '#4e66b6', '#007a72', '#181c22']"
