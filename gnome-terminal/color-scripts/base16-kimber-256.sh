...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Kimber 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-kimber-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#222222', '#C88C8C', '#99C899', '#D8B56D', '#537C9C', '#86CACD', '#78B4B4', '#DEDEE7', '#644646', '#C88C8C', '#99C899', '#D8B56D', '#537C9C', '#86CACD', '#78B4B4', '#FFFFE6']"
