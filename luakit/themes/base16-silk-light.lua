...
local base06 = "#0e3c46" -- +++
local base07 = "#D2FAFF" -- ++++
local base08 = "#CF432E" -- red
local base09 = "#D27F46" -- orange
local base0A = "#CFAD25" -- yellow
local base0B = "#6CA38C" -- green
local base0C = "#329CA2" -- aqua/cyan
local base0D = "#39AAC9" -- blue
local base0E = "#6E6582" -- purple
local base0F = "#865369" -- brown
