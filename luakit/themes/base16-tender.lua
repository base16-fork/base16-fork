...
local base06 = "#e8e8e8" -- +++
local base07 = "#feffff" -- ++++
local base08 = "#f43753" -- red
local base09 = "#dc9656" -- orange
local base0A = "#ffc24b" -- yellow
local base0B = "#c9d05c" -- green
local base0C = "#73cef4" -- aqua/cyan
local base0D = "#b3deef" -- blue
local base0E = "#d3b987" -- purple
