...
local base06 = "#D9D7CE" -- +++
local base07 = "#F3F4F5" -- ++++
local base08 = "#F28779" -- red
local base09 = "#FFAD66" -- orange
local base0A = "#FFD173" -- yellow
local base0B = "#D5FF80" -- green
local base0C = "#95E6CB" -- aqua/cyan
local base0D = "#5CCFE6" -- blue
local base0E = "#D4BFFF" -- purple
local base0F = "#F29E74" -- brown
