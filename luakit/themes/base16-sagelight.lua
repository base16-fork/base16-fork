...
local base06 = "#282828" -- +++
local base07 = "#181818" -- ++++
local base08 = "#fa8480" -- red
local base09 = "#ffaa61" -- orange
local base0A = "#ffdc61" -- yellow
local base0B = "#a0d2c8" -- green
local base0C = "#a2d6f5" -- aqua/cyan
local base0D = "#a0a7d2" -- blue
local base0E = "#c8a0d2" -- purple
local base0F = "#d2b2a0" -- brown
