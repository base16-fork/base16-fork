...
local base06 = "#dfdfdf" -- +++
local base07 = "#f2f2f2" -- ++++
local base08 = "#e74856" -- red
local base09 = "#c19c00" -- orange
local base0A = "#f9f1a5" -- yellow
local base0B = "#16c60c" -- green
local base0C = "#61d6d6" -- aqua/cyan
local base0D = "#3b78ff" -- blue
local base0E = "#b4009e" -- purple
local base0F = "#13a10e" -- brown
