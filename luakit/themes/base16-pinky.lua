...
local base06 = "#ffffff" -- +++
local base07 = "#f7f3f7" -- ++++
local base08 = "#ffa600" -- red
local base09 = "#00ff66" -- orange
local base0A = "#20df6c" -- yellow
local base0B = "#ff0066" -- green
local base0C = "#6600ff" -- aqua/cyan
local base0D = "#00ffff" -- blue
local base0E = "#007fff" -- purple
local base0F = "#df206c" -- brown
