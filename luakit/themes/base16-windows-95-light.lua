...
local base06 = "#2a2a2a" -- +++
local base07 = "#000000" -- ++++
local base08 = "#a80000" -- red
local base09 = "#fcfc54" -- orange
local base0A = "#a85400" -- yellow
local base0B = "#00a800" -- green
local base0C = "#00a8a8" -- aqua/cyan
local base0D = "#0000a8" -- blue
local base0E = "#a800a8" -- purple
