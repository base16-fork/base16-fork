...
local base06 = "#CBF2F7" -- +++
local base07 = "#D2FAFF" -- ++++
local base08 = "#fb6953" -- red
local base09 = "#fcab74" -- orange
local base0A = "#fce380" -- yellow
local base0B = "#73d8ad" -- green
local base0C = "#3fb2b9" -- aqua/cyan
local base0D = "#46bddd" -- blue
local base0E = "#756b8a" -- purple
local base0F = "#9b647b" -- brown
