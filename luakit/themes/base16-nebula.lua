...
local base06 = "#c7c9cd" -- +++
local base07 = "#8dbdaa" -- ++++
local base08 = "#777abc" -- red
local base09 = "#94929e" -- orange
local base0A = "#4f9062" -- yellow
local base0B = "#6562a8" -- green
local base0C = "#226f68" -- aqua/cyan
local base0D = "#4d6bb6" -- blue
local base0E = "#716cae" -- purple
local base0F = "#8c70a7" -- brown
