...
local base06 = "#dddddd" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#ff4136" -- red
local base09 = "#ff851b" -- orange
local base0A = "#ffdc00" -- yellow
local base0B = "#2ecc40" -- green
local base0C = "#7fdbff" -- aqua/cyan
local base0D = "#0074d9" -- blue
local base0E = "#b10dc9" -- purple
local base0F = "#85144b" -- brown
