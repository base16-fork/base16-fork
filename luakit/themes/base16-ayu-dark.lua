...
local base09 = "#FF8F40" -- orange
local base0A = "#FFB454" -- yellow
local base0B = "#B8CC52" -- green
local base0C = "#95E6CB" -- aqua/cyan
local base0D = "#59C2FF" -- blue
local base0E = "#D2A6FF" -- purple
local base0F = "#E6B673" -- brown
