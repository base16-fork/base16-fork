...
local base06 = "#d2d2d2" -- +++
local base07 = "#fcfcfc" -- ++++
local base08 = "#fc5454" -- red
local base09 = "#a85400" -- orange
local base0A = "#fcfc54" -- yellow
local base0B = "#54fc54" -- green
local base0C = "#54fcfc" -- aqua/cyan
local base0D = "#5454fc" -- blue
local base0E = "#fc54fc" -- purple
local base0F = "#00a800" -- brown
