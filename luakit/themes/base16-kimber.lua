...
local base06 = "#C3C3B4" -- +++
local base07 = "#FFFFE6" -- ++++
local base08 = "#C88C8C" -- red
local base09 = "#476C88" -- orange
local base0A = "#D8B56D" -- yellow
local base0B = "#99C899" -- green
local base0C = "#78B4B4" -- aqua/cyan
local base0D = "#537C9C" -- blue
local base0E = "#86CACD" -- purple
local base0F = "#704F4F" -- brown
