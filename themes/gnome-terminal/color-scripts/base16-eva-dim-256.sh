...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Eva Dim 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-eva-dim-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2a3b4d', '#c4676c', '#5de561', '#cfd05d', '#1ae1dc', '#9c6cd3', '#4b8f77', '#9fa2a6', '#55799c', '#c4676c', '#5de561', '#cfd05d', '#1ae1dc', '#9c6cd3', '#4b8f77', '#ffffff']"
