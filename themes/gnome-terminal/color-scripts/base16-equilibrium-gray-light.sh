...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Equilibrium Gray Light"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-equilibrium-gray-light"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f1f1f1', '#d02023', '#637200', '#9d6f00', '#0073b5', '#4e66b6', '#007a72', '#474747', '#777777', '#bf3e05', '#e2e2e2', '#d4d4d4', '#5e5e5e', '#303030', '#c42775', '#1b1b1b']"
...
gset string palette "['#f1f1f1', '#d02023', '#637200', '#9d6f00', '#0073b5', '#4e66b6', '#007a72', '#474747', '#777777', '#bf3e05', '#e2e2e2', '#d4d4d4', '#5e5e5e', '#303030', '#c42775', '#1b1b1b']"
