...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Solar Flare Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-solarflare-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#F5F7FA', '#EF5253', '#7CC844', '#E4B51C', '#33B5E1', '#A363D5', '#52CBB0', '#586875', '#85939E', '#EF5253', '#7CC844', '#E4B51C', '#33B5E1', '#A363D5', '#52CBB0', '#18262F']"
