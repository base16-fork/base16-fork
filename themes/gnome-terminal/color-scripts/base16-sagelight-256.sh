...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Sagelight 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-sagelight-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f8f8f8', '#fa8480', '#a0d2c8', '#ffdc61', '#a0a7d2', '#c8a0d2', '#a2d6f5', '#383838', '#b8b8b8', '#fa8480', '#a0d2c8', '#ffdc61', '#a0a7d2', '#c8a0d2', '#a2d6f5', '#181818']"
