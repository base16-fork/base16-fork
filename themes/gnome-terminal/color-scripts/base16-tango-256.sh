...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Tango 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-tango-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2e3436', '#cc0000', '#4e9a06', '#c4a000', '#3465a4', '#75507b', '#06989a', '#d3d7cf', '#555753', '#cc0000', '#4e9a06', '#c4a000', '#3465a4', '#75507b', '#06989a', '#eeeeec']"
