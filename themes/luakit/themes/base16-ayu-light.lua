...
local base09 = "#FA8D3E" -- orange
local base0A = "#F2AE49" -- yellow
local base0B = "#86B300" -- green
local base0C = "#4CBF99" -- aqua/cyan
local base0D = "#36A3D9" -- blue
local base0E = "#A37ACC" -- purple
local base0F = "#E6BA7E" -- brown
