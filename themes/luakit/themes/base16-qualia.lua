...
local base06 = "#C0C0C0" -- +++
local base07 = "#454545" -- ++++
local base08 = "#EFA6A2" -- red
local base09 = "#A3B8EF" -- orange
local base0A = "#E6A3DC" -- yellow
local base0B = "#80C990" -- green
local base0C = "#C8C874" -- aqua/cyan
local base0D = "#50CACD" -- blue
local base0E = "#E0AF85" -- purple
local base0F = "#808080" -- brown
