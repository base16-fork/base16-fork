...
local base06 = "#42383a" -- +++
local base07 = "#33292b" -- ++++
local base08 = "#df2d52" -- red
local base09 = "#f6661e" -- orange
local base0A = "#c29461" -- yellow
local base0B = "#2e916d" -- green
local base0C = "#1d8991" -- aqua/cyan
local base0D = "#006e93" -- blue
local base0E = "#5e2180" -- purple
local base0F = "#ba0d35" -- brown
