...
local base06 = "#EDEAEF" -- +++
local base07 = "#BBAADD" -- ++++
local base08 = "#A92258" -- red
local base09 = "#918889" -- orange
local base0A = "#804ead" -- yellow
local base0B = "#C6914B" -- green
local base0C = "#7263AA" -- aqua/cyan
local base0D = "#8E7DC6" -- blue
local base0E = "#953B9D" -- purple
local base0F = "#59325C" -- brown
