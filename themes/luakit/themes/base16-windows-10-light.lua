...
local base06 = "#414141" -- +++
local base07 = "#0c0c0c" -- ++++
local base08 = "#c50f1f" -- red
local base09 = "#f9f1a5" -- orange
local base0A = "#c19c00" -- yellow
local base0B = "#13a10e" -- green
local base0C = "#3a96dd" -- aqua/cyan
local base0D = "#0037da" -- blue
local base0E = "#881798" -- purple
local base0F = "#16c60c" -- brown
